...
class Ball:
    ...
    def render(self, colour: Optional[picographics.Pen] = None):
        self.i75.display.set_pen(self.colour if colour is None else colour)
        self.i75.display.circle(round(self.centre.x),
                                round(self.centre.y),
                                self.size)
